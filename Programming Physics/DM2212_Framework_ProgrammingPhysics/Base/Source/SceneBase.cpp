...
void SceneBase::Init()
{
	...
	camera.Init(Vector3(70.f, -8, 60), Vector3(70.f, 50, 10), Vector3(0, 1, 0));
    //camera.Init(Vector3(66.5f, -20, 100), Vector3(66.5f, 50, 0), Vector3(0, 1, 0));
    ...
    meshList[GEO_BALL]->material.kShininess = 0.7;
    meshList[GEO_BALL]->material.kSpecular.Set(0.3f, 0.3f, 0.3f);
    ...
    meshList[GEO_ENEMYBULLET] = MeshBuilder::GenerateQuad("enemybullet", Color(1, 1, 1), 1.f);
    meshList[GEO_ENEMYBULLET]->textureID = LoadTGA("Image//enemybullet.tga");
    meshList[GEO_FIELD] = MeshBuilder::GenerateQuad("Force Field", Color(1, 1, 1), 1.f);
    meshList[GEO_FIELD]->textureID = LoadTGA("Image//field.tga");
    meshList[GEO_MISSILE] = MeshBuilder::GenerateQuad("Missile", Color(1, 1, 1), 1.f);
    ...
    meshList[GEO_FLIPPER]->textureID = LoadTGA("Image//flipper.tga");
    meshList[GEO_PILLAR] = MeshBuilder::GenerateSphere("PILLAR", Color(0.f, 0.6f, 0.8f), 10, 10, 1.f);
    meshList[GEO_BOARD] = MeshBuilder::GenerateQuad("board", Color(1, 1, 1), 1.f, 4, 4);
    meshList[GEO_BOARD]->textureID = LoadTGA("Image//wood.tga");
...
void SceneBase::Update(double dt)
{
    if (changeColor)
    {
        ...
        meshList[GEO_BALL] = MeshBuilder::GenerateSphere("Quad", Color(Math::RandFloatMinMax(0, 1), Math::RandFloatMinMax(0, 1), Math::RandFloatMinMax(0, 1)), 10, 10, 1);
        changeColor = false;
    }
	//Keyboard Section
