...
public:
	...
	static Mesh* GenerateQuad(const std::string &meshName, Color color, float length = 1.f, float tileX = 1.f, float tileY = 1.f);
    static Mesh* GenerateCube(const std::string &meshName, Color color, float length = 1.f, float tileX = 1.f, float tileY = 1.f);
    ...
    static Mesh* GenerateCylinder(const std::string &meshName, Color color, float cylinderHeight, float cylinderTopWidth, float cylinderBotWidth, unsigned numSlices);
};
